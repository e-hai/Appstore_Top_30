    ...
    rising_categories = [
        ...
        },
        {
            ...
            "news_reports": [
                ...
                {
                    "platform": "36氪 行业观察",
                    "title": "36氪观察: 移动端 AI 助手赛道格局初定，头部效应加剧",
                    "url": "https://36kr.com",
                    "snippet": "用户对高性能 AI 工具的付费意愿显著提升，应用内内购订阅成为核心变现支柱。",
                },
            ],
            "recommendation": "💡 【跟进建议】工具层跟进难度高（大模型算力门槛），建议切入“垂直场景套壳工具”（如 AI 简历/AI 绘图/AI 音视频剪辑）。",
        },
        {
            "rank": 3,
            ...
            "recommendation": "⚠️ 【跟进建议】该品类属于 To-School 机构采购驱动型，B 端校方渠道壁垒极高，C 端开发者不宜盲目抄袭。",
        },
    ]
    ...
    declining_categories = [
        {
            ...
            "recommendation": "🛑 【跟进建议】不建议研发传统纯三消，建议转向“合成+装修”或“三消+RPG 混合玩法”。",
        },
        {
            "rank": 2,
            ...
            "news_reports": [
                {
                    ...
                    "title": "【超休闲寒冬】纯 IAA 超休闲小游戏买量模型难以为继",
                    "url": "https://venturebeat.com",
                    "snippet": "超休闲游戏厂商纷纷向“混合休闲 (Hybrid Casual)”转型，增加内购与中度养成线。",
                }
            ],
            "recommendation": "🛑 【跟进建议】避免纯超休闲方向，必须引入轻度内购与中度养成外围。",
        },
        {
            "rank": 3,
            ...
            "news_reports": [
                {
                    "platform": "IT之家 科技快讯",
                    "title": "IT之家观察: 放置卡牌手游市场洗牌，同质化产品加速出局",
                    "url": "https://ithome.com",
                    "snippet": "缺乏题材突破与数值创新的放置挂机手游面临高流失率与买量亏损。",
                }
            ],
            "recommendation": "⚠️ 【跟进建议】放置卡牌仍有大盘，但必须有顶级的美术题材差异化（如韩系暗黑/赛博朋克）才可尝试。",
        },
    ]
